...
<input type="image" value="Ver Detalles" src="./imagenes/ver.png" style="width: 120px; height: 30px;" /><!--este es el boton-->
...
<input type="image" value="Agregar al carrito" src="./imagenes/agregar.png" style="width: 120px; height: 30px;" /><!--este es el boton-->
		...
		<br>
		<br>
		<h2>No hay productos en esta categoria, le pedimos una disculta Att: Jugueteria JUBE</h2>
		<br>
		<br>
		';
		}
